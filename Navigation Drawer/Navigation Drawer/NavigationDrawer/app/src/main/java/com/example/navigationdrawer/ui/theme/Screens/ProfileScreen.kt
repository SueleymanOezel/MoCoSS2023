...
// Eine Funktion, die den Profile-Screen als Composable definiert
@Composable
        ...
        content = { padding -> // Hier habe ich den padding Parameter hinzugefügt und verwendet
            ...
            Column(
                modifier = Modifier.fillMaxSize()
                    .padding(padding), // Hier habe ich den Modifier angepasst
                horizontalAlignment = Alignment.CenterHorizontally,
                verticalArrangement = Arrangement.SpaceEvenly
            ) {
                // Das Profilbild als Image-Composable mit einem Klick-Listener
                Image(
                ...
                // Die Daten des Users als Text-Composables mit einem Modifier zum Anpassen der Breite und Höhe
                Text(
                ...
                if (editMode.value) {
                    TextField(
                        ...
                        onValueChange = { currentUser.value.password = it },
                        label = { Text(text = "Neues Passwort") },
                        modifier = Modifier.fillMaxWidth().height(50.dp)
                    )
                    Button(
                        onClick = {
                            // Hier kann die Logik zum Speichern des neuen Passworts implementiert werden (z.B. mit einer Datenbank- oder SharedPreferences-Aktivität)
                            // Wenn das Speichern erfolgreich ist, wird der Bearbeitungsmodus beendet und die Fehlermeldung geleert
                            // Wenn das Speichern fehlschlägt, wird eine Fehlermeldung angezeigt
